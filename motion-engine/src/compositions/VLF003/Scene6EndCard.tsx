...
/**
 * Scene 6 — CTA end card (0:30–0:36)
 * Solid dark background, centered two-line CTA — "That's the whole thing.
...
export const Scene6EndCard: FC = () => {
  ...
  const linkOpacity = interpolate(frame, [10, 22], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });

  const lineWidth = interpolate(frame, [22, 36], [0, 100], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  ...
  return (
    ...
    >
      ...
      >
        That&apos;s the whole thing. See how it works.
      </div>
      <div
        style={{
          width: `${lineWidth}%`,
