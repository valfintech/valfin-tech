...
export const hero = {
  ...
  headline: "Your competitors aren't better than you. They just call back faster.",
  subheadline:
...
export const trust = {
  ...
  pillars: [
    ...
    },
    {
      ...
      description: "Not “results may vary” — actual, specific, sometimes unglamorous numbers from the business we built this in.",
    },
    {
...
export const finalCta = {
  headline: "Your next customer already tried to reach you.",
  subheadline: "The only question left is whether anyone was there to answer — and whether that's about to change.",
