...
export const originStory = {
  ...
  paragraphs: [
    ...
    "That's the company we built. Not an AI company looking for a problem to solve — a business that found a very real, very expensive problem first, fixed it for itself, and then built the system to fix it for others.",
  ],
};
