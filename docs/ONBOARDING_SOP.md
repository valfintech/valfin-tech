...
4. **When the client is happy and stable (typically month 2–3):** open the Tier 3 menu in `PRICING_PACKAGING.md` — this is expansion-revenue territory, not a Day-1 pitch
